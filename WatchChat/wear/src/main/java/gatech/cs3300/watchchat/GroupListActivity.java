...
public class GroupListActivity extends Activity implements WearableListView.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems.add("Group 1");
        listItems.add("Group 2");
        listItems.add("Group 3");
        listItems.add("Group 4");
        listItems.add("Group 5");
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                mListView.setAdapter(new ListAdapter(GroupListActivity.this));
                mListView.setClickListener(GroupListActivity.this);
    ...
    public void onClick(WearableListView.ViewHolder viewHolder) {
        ...
        resultIntent.putExtra("group_name", listItems.get(selectedIndex));
